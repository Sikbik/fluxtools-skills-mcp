---
name: flux-cloud
description: Use when working with Flux Cloud or FluxOS from Codex. This adapter routes work into the shared Fluxtools skills library and keeps execution CLI-first with MCP fallback.
---

# Flux Cloud (Codex Adapter)

This is the Codex-facing adapter for the shared Fluxtools skills library.
